...
public class CraftingManager {
    ...
    private CraftingManager() {
        ...
        this.addRecipe(new ItemStack(Item.cake, 1), "AAA", "BEB", "CCC", 'A', Item.bucketMilk, 'B',
        ...
        this.addRecipe(new ItemStack(Block.railActivator, 6), "XSX", "X#X", "XSX", 'X', Item.ingotIron,
                '#', Block.torchRedstoneActive, 'S', Item.stick);
        this.addRecipe(new ItemStack(Block.railDetector, 6), "X X", "X#X", "XRX", 'X', Item.ingotIron,
        ...
        this.addRecipe(new ItemStack(Item.minecartPowered, 1),
                "A", "B", 'A', Block.furnaceIdle, 'B', Item.minecartEmpty);
        this.addRecipe(new ItemStack(Item.tntMinecart, 1),
                "A", "B", 'A', Block.tnt, 'B', Item.minecartEmpty);
        this.addRecipe(new ItemStack(Item.hopperMinecart, 1),
                "A", "B", 'A', Block.hopperBlock, 'B', Item.minecartEmpty);
        ...
        this.addRecipe(new ItemStack(Item.carrotOnAStick, 1),
                "# ", " X", '#', Item.fishingRod, 'X', Item.carrot).func_92100_c();
        ...
        this.addRecipe(new ItemStack(Item.goldenCarrot, 1, 0),
                "###", "#X#", "###", '#', Item.goldNugget, 'X', Item.carrot);
        ...
        this.addRecipe(new ItemStack(Item.comparator, 1), " # ", "#X#", "III", '#',
        ...
        this.addRecipe(new ItemStack(Block.dropper, 1),
                "###", "# #", "#R#", '#', Block.cobblestone, 'R', Item.redstone);
        this.addRecipe(new ItemStack(Block.pistonBase, 1), "TTT", "#X#", "#R#", '#', Block.cobblestone,
        ...
        this.addRecipe(new ItemStack(Block.anvil, 1),
                "III", " i ", "iii", 'I', Block.blockIron, 'i', Item.ingotIron);
        ...
        this.addRecipe(new ItemStack(Block.daylightSensor), "GGG", "QQQ", "WWW", 'G', Block.glass, 'Q',
                Item.netherQuartz, 'W', Block.woodSingleSlab);
        this.addRecipe(new ItemStack(Block.hopperBlock),
                "I I", "ICI", " I ", 'I', Item.ingotIron, 'C', Block.chest);
