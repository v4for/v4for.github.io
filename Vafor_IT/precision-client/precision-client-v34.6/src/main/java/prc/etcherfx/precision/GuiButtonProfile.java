...
public class GuiButtonProfile extends GuiButton {
    public GuiButtonProfile(int par1, int par2, int par3) {
        super(par1, par2, par3, 18, 18, "");
    }

    private static final TextureLocation tex_gui = new TextureLocation("/precision/gui2.png");
