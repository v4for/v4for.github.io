    ...
    public void renderPlayer(EntityPlayer par1EntityPlayer, double par2, double par4, double par6, float par8, float par9) {
        ...
        if (isHiPoly && fnawEnabled) {
            ...
            if (DefaultSkinRenderer.isZombieModel(renderType)) {
                if (DefaultSkinRenderer.zombieRenderer == null)
                    DefaultSkinRenderer.zombieRenderer = new ModelZombie(0.0F, true);
                ...
                switch (renderType) {
                    case 32:
                        if (DefaultSkinRenderer.villagerRenderer == null)
                            DefaultSkinRenderer.villagerRenderer = new ModelVillager(0.0F);
                        ...
                        break;
                    case 19:
                        if (DefaultSkinRenderer.endermanRenderer == null)
                            DefaultSkinRenderer.endermanRenderer = new ModelEnderman();
                        ...
                        break;
                    case 20:
                        if (DefaultSkinRenderer.skeletonRenderer == null)
                            DefaultSkinRenderer.skeletonRenderer = new ModelSkeleton(0.0F);
                        ...
                        break;
                    case 21:
                        if (DefaultSkinRenderer.blazeRenderer == null)
                            DefaultSkinRenderer.blazeRenderer = new ModelBlaze();
