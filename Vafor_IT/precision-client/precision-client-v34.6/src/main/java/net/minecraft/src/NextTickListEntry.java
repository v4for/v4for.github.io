...
public class NextTickListEntry implements Comparable {
    ...
    public int comparer(NextTickListEntry par1NextTickListEntry) {
        return this.scheduledTime < par1NextTickListEntry.scheduledTime ? -1
                ...
                : (this.field_82754_f != par1NextTickListEntry.field_82754_f ? this.field_82754_f - par1NextTickListEntry.field_82754_f
                : (this.tickEntryID < par1NextTickListEntry.tickEntryID ? -1 : (this.tickEntryID > par1NextTickListEntry.tickEntryID ? 1 : 0))));
    }
