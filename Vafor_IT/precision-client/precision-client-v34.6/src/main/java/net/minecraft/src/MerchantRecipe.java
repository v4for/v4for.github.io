...
public class MerchantRecipe {
    ...
    public boolean hasSameIDsAs(MerchantRecipe par1MerchantRecipe) {
        return this.itemToBuy.itemID == par1MerchantRecipe.itemToBuy.itemID && this.itemToSell.itemID == par1MerchantRecipe.itemToSell.itemID && (this.secondItemToBuy == null && par1MerchantRecipe.secondItemToBuy == null
