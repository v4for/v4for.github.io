...
public abstract class SelectionListBase {
    ...
    public void func_96612_a(int par1, int par2, float par3) {
        ...
        var18.addVertexWithUV(this.field_96619_e, this.field_96627_h, 0.0D, (float) this.field_96619_e / var17, (float) (this.field_96627_h + (int) this.field_96626_k) / var17);
        var18.addVertexWithUV(this.field_96617_g, this.field_96627_h, 0.0D, (float) this.field_96617_g / var17, (float) (this.field_96627_h + (int) this.field_96626_k) / var17);
        var18.addVertexWithUV(this.field_96617_g, this.field_96616_f, 0.0D, (float) this.field_96617_g / var17, (float) (this.field_96616_f + (int) this.field_96626_k) / var17);
        var18.addVertexWithUV(this.field_96619_e, this.field_96616_f, 0.0D, (float) this.field_96619_e / var17, (float) (this.field_96616_f + (int) this.field_96626_k) / var17);
        var18.draw();
        ...
        var18.addVertexWithUV(this.field_96619_e, this.field_96616_f + var19, 0.0D, 0.0D, 1.0D);
        var18.addVertexWithUV(this.field_96617_g, this.field_96616_f + var19, 0.0D, 1.0D, 1.0D);
        var18.setColorRGBA_I(0, 255);
        var18.addVertexWithUV(this.field_96617_g, this.field_96616_f, 0.0D, 1.0D, 0.0D);
        var18.addVertexWithUV(this.field_96619_e, this.field_96616_f, 0.0D, 0.0D, 0.0D);
        var18.draw();
        var18.startDrawingQuads();
        var18.setColorRGBA_I(0, 255);
        var18.addVertexWithUV(this.field_96619_e, this.field_96627_h, 0.0D, 0.0D, 1.0D);
        var18.addVertexWithUV(this.field_96617_g, this.field_96627_h, 0.0D, 1.0D, 1.0D);
        var18.setColorRGBA_I(0, 0);
        var18.addVertexWithUV(this.field_96617_g, this.field_96627_h - var19, 0.0D, 1.0D, 0.0D);
        var18.addVertexWithUV(this.field_96619_e, this.field_96627_h - var19, 0.0D, 0.0D, 0.0D);
        var18.draw();
        var20 = this.func_96607_d();
        ...
        if (var20 > 0) {
            ...
            var18.startDrawingQuads();
            var18.setColorRGBA_I(0, 255);
            var18.addVertexWithUV(var5, this.field_96627_h, 0.0D, 0.0D, 1.0D);
            var18.addVertexWithUV(var6, this.field_96627_h, 0.0D, 1.0D, 1.0D);
            var18.addVertexWithUV(var6, this.field_96616_f, 0.0D, 1.0D, 0.0D);
            var18.addVertexWithUV(var5, this.field_96616_f, 0.0D, 0.0D, 0.0D);
            var18.draw();
            var18.startDrawingQuads();
