...
public class EntityVillager extends EntityAgeable implements INpc, IMerchant {
    ...
    public EntityVillager(int par2) {
        super();
    ...
    private void generateRandomParticles(String par1Str) {
        for (int var2 = 0; var2 < 5; ++var2) {
            ...
            this.worldObj.spawnParticle(par1Str, this.posX + (double) (this.rand.nextFloat() * this.width * 2.0F) - (double) this.width, this.posY + 1.0D + (double) (this.rand.nextFloat() * this.height),
                    this.posZ + (double) (this.rand.nextFloat() * this.width * 2.0F) - (double) this.width, var3, var5, var7);
        }
    }
    ...
    public EntityVillager func_90012_b(EntityAgeable par1EntityAgeable) {
        EntityVillager var2 = new EntityVillager();
