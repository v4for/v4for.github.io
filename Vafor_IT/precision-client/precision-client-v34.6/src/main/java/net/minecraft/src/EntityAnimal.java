...
public abstract class EntityAnimal extends EntityAgeable implements IAnimals {
    ...
    public void onLivingUpdate() {
        ...
        if (this.inLove > 0) {
            ...
            if (this.inLove % 10 == 0) {
                ...
                this.worldObj.spawnParticle(var1, this.posX + (double) (this.rand.nextFloat() * this.width * 2.0F) - (double) this.width, this.posY + 0.5D + (double) (this.rand.nextFloat() * this.height),
            ...
            if (this.getGrowingAge() > 0 && var8.getGrowingAge() < 0) {
                ...
                if (var8.entityToAttack == this && (double) par2 < 3.5D) {
                    ...
                    if (this.breeding % 4 == 0) {
                        this.worldObj.spawnParticle("heart", this.posX + (double) (this.rand.nextFloat() * this.width * 2.0F) - (double) this.width, this.posY + 0.5D + (double) (this.rand.nextFloat() * this.height),
    ...
    protected Entity findPlayerToAttack() {
        if (this.fleeingTick > 0) {
            ...
            if (this.inLove > 0) {
                var2 = this.worldObj.getEntitiesWithinAABB(this.getClass(), this.boundingBox.expand(var1, var1, var1));
                ...
                var2 = this.worldObj.getEntitiesWithinAABB(EntityPlayer.class, this.boundingBox.expand(var1, var1, var1));
