...
public class TileEntityHopper extends TileEntity implements Hopper {
    ...
    public static IInventory getInventoryAtLocation(World par0World, double par1, double par3, double par5) {
        ...
        if (var7 == null) {
            List var14 = par0World.getEntitiesWithinAABBExcludingEntity(null, AxisAlignedBB.getAABBPool().getAABB(par1, par3, par5, par1 + 1.0D, par3 + 1.0D, par5 + 1.0D), IEntitySelector.selectInventories);
