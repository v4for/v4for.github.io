...
public class GuiContainerCreative extends InventoryEffectRenderer {
    private static final InventoryBasic inventory = new InventoryBasic("tmp", true, 45);
     ...
     * with the player's inventory slots for the inventory tab.
     */
    ...
    public void drawScreen(int par1, int par2, float par3) {
        boolean var4 = EaglerAdapter.mouseIsButtonDown(0);
    ...
    private static final TextureLocation tex = new TextureLocation("/gui/allitems.png");
