...
public abstract class EntityTameable extends EntityAnimal {
    ...
    protected void playTameEffect(boolean par1) {
        ...
        for (int var3 = 0; var3 < 7; ++var3) {
            ...
            this.worldObj.spawnParticle(var2, this.posX + (double) (this.rand.nextFloat() * this.width * 2.0F) - (double) this.width, this.posY + 0.5D + (double) (this.rand.nextFloat() * this.height),
