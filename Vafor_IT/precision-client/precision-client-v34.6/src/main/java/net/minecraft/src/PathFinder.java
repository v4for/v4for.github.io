...
public class PathFinder {
    ...
    private PathEntity createEntityPathTo(Entity par1Entity, double par2, double par4, double par6, float par8) {
        ...
        if (this.canEntityDrown && par1Entity.isInWater()) {
            ...
            for (int var11 = this.worldMap.getBlockId(MathHelper.floor_double(par1Entity.posX), var10, MathHelper.floor_double(par1Entity.posZ)); var11 == Block.waterMoving.blockID
                    || var11 == Block.waterStill.blockID; var11 = this.worldMap.getBlockId(MathHelper.floor_double(par1Entity.posX), var10, MathHelper.floor_double(par1Entity.posZ))) {
                ++var10;
            }
     ...
     * for colliding with any solid block, -1 for water(if avoiding water) but
     * otherwise clear, -2 for lava, -3 for fence, -4 for closed trapdoor, 2 if
