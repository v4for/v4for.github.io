...
public class EffectRenderer {
    ...
    private static final TextureLocation particles = new TextureLocation("/particles.png");
    ...
    public void renderTransparentParticles(Entity par1Entity, float par2) {
        particles.bindTexture();
        float var3 = ActiveRenderInfo.rotationX;
        float var4 = ActiveRenderInfo.rotationZ;
        float var5 = ActiveRenderInfo.rotationYZ;
        ...
        for (int var10 = 0; var10 < this.fxLayers[0].size(); ++var10) {
            EntityFX var11 = (EntityFX) this.fxLayers[0].get(var10);
            if (var11.particleAlpha != 1.0F) {
                var9.setBrightness(var11.getBrightnessForRender(par2));
                var11.renderParticle(var9, par2, var3, var7, var4, var5, var6);
            }
            ...
            for (int var8 = 0; var8 < var7; ++var8) {
                for (int var9 = 0; var9 < var7; ++var9) {
                    for (int var10 = 0; var10 < var7; ++var10) {
                        ...
                        this.addEffect((new EntityDiggingFX(this.worldObj, var11, var13, var15, var11 - (double) par1 - 0.5D, var13 - (double) par2 - 0.5D, var15 - (double) par3 - 0.5D, var6, var17, par5, this.renderer)).func_70596_a(par1,
                                par2, par3));
                    }
                }
            }
    ...
    public void addBlockHitEffects(int par1, int par2, int par3, int par4) {
        ...
        if (var5 != 0) {
            ...
            this.addEffect((new EntityDiggingFX(this.worldObj, var8, var10, var12, 0.0D, 0.0D, 0.0D, var6, par4, this.worldObj.getBlockMetadata(par1, par2, par3), this.renderer)).func_70596_a(par1, par2, par3).multiplyVelocity(0.2F)
