...
public class EntityDamageSource extends DamageSource {
    ...
    public String getDeathMessage(EntityLiving par1EntityLiving) {
        ...
        return var2 != null && var2.hasDisplayName() && StatCollector.func_94522_b(var4)
                ? StatCollector.translateToLocalFormatted(var4, par1EntityLiving.getTranslatedEntityName(), this.damageSourceEntity.getTranslatedEntityName(), var2.getDisplayName())
                : StatCollector.translateToLocalFormatted(var3, par1EntityLiving.getTranslatedEntityName(), this.damageSourceEntity.getTranslatedEntityName());
    }
