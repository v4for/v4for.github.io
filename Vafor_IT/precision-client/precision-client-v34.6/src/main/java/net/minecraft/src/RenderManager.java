...
public class RenderManager {
    ...
    /**
     * Caches the current frame's active render info, including the current World,
     * RenderEngine, GameSettings and FontRenderer settings, as well as interpolated
     * player position, pitch and yaw.
     */
    ...
    /**
     * Will render the specified entity at the specified partial tick time. Args:
