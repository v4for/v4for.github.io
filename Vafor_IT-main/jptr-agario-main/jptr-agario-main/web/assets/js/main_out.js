// Edited by prkr / th3skeleton
// Made for jptragar (https://jptragar.gltich.me)
...
(function () {
    ...
    var wsUrl = null,
        //SKIN_URL = "this.skin", GET THAT SHIT OUTTA HERE
...
*/
    ...
    /*
        function buildGallery() {
            ...
            for (var i = 0; i < sortedKeys.length; i++) {
                ...
                console.log("{")
                console.log('"src": "https://cdn.glitch.me/2d6e8d70-57a5-4dd2-b4bb-c1505f83f020/' + name + '.png"');
    ...
    */
    ...
    function buildGallery() {
        ...
        fetch("./skinList.json")
            ...
            .then(function (data) {
                ...
                for (var i = 0; i < gal.skins.length; i++) {
                    if (src.indexOf(gal.skins[i].src) == -1) {
                        src.push(gal.skins[i].src)
                    }
                    if (name.indexOf(gal.skins[i].label) == -1) {
                        name.push(gal.skins[i].label)
                    }
                }
                //console.log(src);
                //console.log(name);
                ...
                for (var i = 0; i < gal.skins.length; i++) {
                    c += '<li class="skin" onclick="changeSkin(\'' + src[i] + '\')">';
                    c += '<img class="circular" src="' + src[i] + '">';
                    c += '<h4 class="skinName">' + name[i] + '</h4>';
                    c += '</li>';
                }
                byId("skinsUL").innerHTML = c;
            })
            .catch(function (err) {
    ...
    function buildUpdates() {
        byId("update-body").innerHTML = '<div> <h2 id="title-updates">Updates</h2>\n <div>\n <hr>\n <center>\n <hr>\n <span class="updates"> 03/23/23 - New update, Super Rainbow, Auto-Merge fixed, 41 new skins and new FFA server cap because I dont want it to be lag city. If you cant join the first server join the 2nd, not different at all. </span>\n <hr>\n<span class="updates"> 12/27/22 - <b>REBIRTH UPDATE</b> - Custom skins have been implemented so you can show off and stand out, a new ui change to make it stand out, new and improved servers and modes, AND international servers for Europe. no update has ever even come close to being this big.</span> <hr><span class="updates"> 05/12/22 - <b>BIG UPDATE</b> - NEW &amp; BETTER SERVERS, NEW GAMEMODES <b>[BATTLE ROYALE, TEAMS, SUPER RAINBOW]</b>,MORE PUBLIC SERVERS, MORE SKINS [75+], REVAMPED SITE WITH FIXED STYLE ISSUES, SKIN SUGGESTIONS ARE OPEN. This is the biggest update yet. </span>\n <hr>\n <span class="updates"> 05/11/22 - Skins, Skins and more skins (42 more skins) </span>\n <hr>\n <span class="updates"> 05/08/22 - Public servers have been released </span>\n <hr>\n <span class="updates"> 05/03/22 - Offically released to the public </span>\n <hr>\n <span class="updates"> 03/11/20 - The page was offically made </span>\n <hr>\n </center>\n </div> </div>';
    }

    function buildCredits() {
        //byId("credit-body").innerHTML = '<div>\n<h2 id="title-updates">Credits</h2>\n<div>\n<hr>\n<center>\n<span class="credits">\n<h4>Created by:</h4> 🚀 prkr <i class="fa-regular fa-skull"></i> <br> <a href="https://imadejptr.com" target="_blank">🚀 imadejptr</a> </span>\n<hr>\n<span class="credits">\n<h4>Inspired by:</h4> 🚀 <a href="https://github.com/Cigar2/Cigar2" target="_blank">Cigar2 by Tombez <i class="fa-brands fa-github"></i></a>\n<br>🚀 <a href="https://mk-agario.glitch.me/" target="_blank">MK Agario by MK</a>\n<br>🚀 <a href="https://github.com/Luka967/OgarII" target="_blank">OgarII by Luka967 <i class="fa-brands fa-github"></i></a>\n<br>🚀 <a href="https://github.com/agarian-2/MultiOgar" target="_blank">MultiOgar by agarian-2 <i class="fa-brands fa-github"></i></a>\n<br>🚀 <a href="https://discord.gg/27v68Sb" target="_blank">Agario Private Servers Discord Server <i class="fa-brands fa-discord"></i></a>\n</span>\n<hr>\n<span class="credits">\n<h4>Shoutout to:</h4> 🚀 <a href="https://shsgames.github.io/" target="_blank">SHSGames <i class="fa-solid fa-gamepad-modern"></i></a>\n<br>🚀 <a href="https://sites.google.com/site/unblockedgame67/" target="_blank">unblocked games 67 <i class="fa-solid fa-gamepad-modern"></i></a>\n<br>🚀 <a href="https://sites.google.com/view/iogames" target="_blank">io games unblocked <i class="fa-solid fa-gamepad-modern"></i></a>\n</span>\n<hr>\n</center>\n</div>\n</div>';
        //byId("credit-body").innerHTML = "<center><h4 style='color:white;'>Created By:</h4><hr><div class='container'><div class='card flex-row colmun'> <div class='col-left card-image'> <div class='profile-img'> <img src='https://pbs.twimg.com/profile_images/1606035385104191489/Vdnb_tUG_400x400.jpg' alt='profile'> </div> </div> <div class='col-right card-info'> <div class='card-info-inner'> <h2 class='uname'>prkr <i style='color: #fff;' class='fa-duotone fa-badge-check'></i></h2>  <ul class='social'> <li style='background-color: #000;'><a href='https://github.com/Th3Skeleton' target='_blank'><i class='fa-brands fa-github'></i></a></li> <li style='background-color: #1DA1F2;'><a href='https://twitter.com/Th3Skeletxn' target='_blank'><i class='fa-brands fa-twitter'></i></a></li> <li style='background-color: #ffadef;'><a href='https://glitch.com/@prkr' target='_blank'>🎏</a></li> </ul> </div> </div> </div> <div class='card flex-row colmun'> <div class='col-left card-image'> <div class='profile-img'> <img src='https://cdn.glitch.global/9c8c96bb-a059-45d7-8b2b-d37ee6083aa6/logo.png' alt='profile'> </div> </div> <div class='col-right card-info'> <div class='card-info-inner'> <h2 class='uname'>imadejptr <i style='color: #fff;' class='fa-duotone fa-badge-check'></i></h2> <ul class='social'> <li style='background-color: #5865f2;'><a href='https://discord.gg/UQ35z2ACNw' target='_blank'><i class='fa-brands fa-discord'></i></a></li> <li style='background-color: #000;'><a href='https://github.com/imadejptr' target='_blank'><i class='fa-brands fa-github'></i></a></li> <li style='background-color: #ffadef;'><a href='https://glitch.com/~imadejptr' target='_blank'>🎏</a></li> </ul> </div> </div> </div><div class='card flex-row colmun'> <div class='col-left card-image'> <div class='profile-img'> <img src='https://avatars.githubusercontent.com/u/38099129?s=200&v=4' alt='profile'> </div> </div> <div class='col-right card-info'> <div class='card-info-inner'> <h2 class='uname'>Cigar2 <i style='color: #fff;' class='fa-duotone fa-badge-check'></i></h2> <ul class='social'> <li style='background-color: #5865f2;'><a href='https://discord.gg/CfvdZZrCKE' target='_blank'><i class='fa-brands fa-discord'></i></a></li> <li style='background-color: #000;'><a href='https://github.com/cigar2/cigar2' target='_blank'><i class='fa-brands fa-github'></i></a></li> <li style='background-color: #ffadef;'><a href='http://cigar2.glitch.me/' target='_blank'>🎏</a></li> </ul> </div> </div> </div></div> <hr><h4 style='color:white;'>special thanks to:</h4><hr><div class='container'><div class='card flex-row colmun'> <div class='col-left card-image'> <div class='profile-img'> <img src='https://shsgames.github.io/icon.png' alt='profile'> </div> </div> <div class='col-right card-info'> <div class='card-info-inner'> <h2 class='uname'>SHSGames <i style='color: #fff;' class='fa-duotone fa-badge-check'></i></h2>  <ul class='social'> <li style='background-color: #000;'><a href='https://github.com/SHSGames/SHSGames' target='_blank'><i class='fa-brands fa-github'></i></a></li> <li style='background-color: #1DA1F2;'><a href='https://shsgames.github.io/' target='_blank'><i class='fa-solid fa-gamepad'></i></a></li> <li style='background-color: #5865f2;'><a href='https://discord.gg/4Yb4yHeuxQ' target='_blank'><i class='fa-brands fa-discord'></i></a></li> </ul> </div> </div> </div> <div class='card flex-row colmun'> <div class='col-left card-image'> <div class='profile-img'> <img src='https://cdn.glitch.global/2d6e8d70-57a5-4dd2-b4bb-c1505f83f020/EmbeddedImage.png' alt='profile'> </div> </div> <div class='col-right card-info'> <div class='card-info-inner'> <h2 class='uname'>iogames <i style='color: #fff;' class='fa-duotone fa-badge-check'></i></h2> <ul class='social'> <li style='background-color: #5865f2;'><a href='https://discord.gg/UQ35z2ACNw' target='_blank'><i class='fa-brands fa-discord'></i></a></li> <li style='background-color: #000;'><a href='https://github.com/imadejptr' target='_blank'><i class='fa-brands fa-github'></i></a></li> <li style='background-color: #ffadef;'><a href='https://glitch.com/~imadejptr' target='_blank'>🎏</a></li> </ul> </div> </div> </div><div class='card flex-row colmun'> <div class='col-left card-image'> <div class='profile-img'> <img src='https://avatars.githubusercontent.com/u/38099129?s=200&v=4' alt='profile'> </div> </div> <div class='col-right card-info'> <div class='card-info-inner'> <h2 class='uname'>Cigar2 <i style='color: #fff;' class='fa-duotone fa-badge-check'></i></h2> <ul class='social'> <li style='background-color: #5865f2;'><a href='https://discord.gg/CfvdZZrCKE' target='_blank'><i class='fa-brands fa-discord'></i></a></li> <li style='background-color: #000;'><a href='https://github.com/cigar2/cigar2' target='_blank'><i class='fa-brands fa-github'></i></a></li> <li style='background-color: #ffadef;'><a href='http://cigar2.glitch.me/' target='_blank'>🎏</a></li> </ul> </div> </div> </div></div></center>";
        byId("credit-body").innerHTML += "<hr><div class='container'><div class='card flex-row colmun'> <div class='col-left card-image'> <div class='profile-img'> <img src='https://pbs.twimg.com/profile_images/1606035385104191489/Vdnb_tUG_400x400.jpg' alt='profile'> </div> </div> <div class='col-right card-info'> <div class='card-info-inner'> <h2 class='uname'>prkr <i style='color: #fff;' class='fa-duotone fa-badge-check'></i></h2> <p class='desc'>Hey its prkr aka Th3Skeleton, I'm the owner and founder of jptr agario. I hope you enjoy this as much as I loved to make it. A little about me, I like rocket league, music enjoyer, sport freak, licensed middle seat holder. Be sure to check out my socials below, I love you guys <3.</p>  <ul class='social'> <li style='background-color: #1DB954;'><a href='https://open.spotify.com/user/a3tbi6nohcmwbopj79l9ob9rf/' target='_blank'>Spotify <i class='fa-brands fa-spotify'></i></a></li> <li style='background-color: #f09433;' style='color:#000;' id='insta'><a href='https://www.instagram.com/prkrs9/' target='_blank'>Instagram <i class='fa-brands fa-instagram'></i></a></li> <li style='background-color: #000;'><a href='https://github.com/Th3Skeleton' target='_blank'>Github <i class='fa-brands fa-github'></i></a></li> <li style='background-color: #1DA1F2;'><a href='https://twitter.com/Th3Skeletxn' target='_blank'>Twitter <i class='fa-brands fa-twitter'></i></a></li> <li style='background-color: #ffadef;'><a href='https://glitch.com/@prkr' target='_blank'>Glitch 🎏</a></li> </ul> </div> </div> </div></div>";
        byId("credit-body").innerHTML += "<hr><div class='container'><div style='background:#c88b3a8e;' class='card flex-row colmun'> <div class='col-left card-image'> <div class='profile-img'> <img src='https://cdn.glitch.global/9c8c96bb-a059-45d7-8b2b-d37ee6083aa6/logo.png' alt='profile'> </div> </div> <div class='col-right card-info'> <div class='card-info-inner'> <h2 class='uname'>imadejptr <i style='color: #fff;' class='fa-duotone fa-badge-check'></i></h2> <p class='desc'>imadejptr is the best game site in the milky way, offering clarity to make you want to come back for another play. With games ranging from Slope to Slither.io to old games like Pokemon and Mario Bros, this site has it all. Go and check it out at <a href='https://www.imadejptr.com/' target='_blank'>https://www.imadejptr.com</a></p>  <ul class='social'> <li style='background-color: #000;'><a href='https://github.com/imadejptr' target='_blank'>Github <i class='fa-brands fa-github'></i></a></li> <li style='background-color: #c88b3a;'><a href='https://www.imadejptr.com/' target='_blank'>Website <i class='fa-solid fa-gamepad-modern'></i></a></li> <li style='background-color: #5865f2;'><a href='https://discord.gg/UQ35z2ACNw' target='_blank'>Discord <i style='color:#fff;' class='fa-brands fa-discord'></i></a></li> <li style='background-color: #ffadef;'><a href='https://glitch.com/~imadejptr' target='_blank'>Glitch 🎏</a></li> </ul> </div> </div> </div></div>";
        byId("credit-body").innerHTML += "<hr><div class='container'><div style='background:#2596be8e;' class='card flex-row colmun'> <div class='col-left card-image'> <div class='profile-img'> <img src='https://pbs.twimg.com/profile_images/1471678321171877896/Ag9Qb1cF_400x400.jpg' alt='profile'> </div> </div> <div class='col-right card-info'> <div class='card-info-inner'> <h2 class='uname'>marcopetrildesigns <i style='color: #fff;' class='fa-duotone fa-badge-check'></i></h2> <p class='desc'>marcopetrildesigns offers affordable and high quality designs from logo designs (like my very own logo) to designs for your favorite team/player, and stunning commissions that will make your eyes water with joy. Go check him out hes dope.</p>  <ul class='social'> <li style='background-color: #f09433;' style='color:#000;' id='insta'><a href='https://www.instagram.com/marcopetrildesigns/' target='_blank'>Instagram <i class='fa-brands fa-instagram'></i></a></li> <li style='background-color: #1DA1F2;'><a href='https://twitter.com/marcopdesigns' target='_blank'>Twitter <i class='fa-brands fa-twitter'></i></a></li> <li style='background-color: #000;'><a href='https://marcopetrildesigns.myportfolio.com/' target='_blank'>Portfolio <i class='fa-duotone fa-book-sparkles'></i></a></li> </ul> </div> </div> </div></div>";
        byId("credit-body").innerHTML += "<hr><div class='container'><div style='background:#0675cf8e;' class='card flex-row colmun'> <div class='col-left card-image'> <div class='profile-img'> <img src='https://shsgames.github.io/icon.png' alt='profile'> </div> </div> <div class='col-right card-info'> <div class='card-info-inner'> <h2 class='uname'>SHSGames <i style='color: #fff;' class='fa-duotone fa-badge-check'></i></h2> <p class='desc'>SHSGames is one of the top and best unblocked game sites out there. With loads of compatible games including a large flash games roster, this site has it all. Go check it out and thank you SHSGames for giving this site exposure!</p>  <ul class='social'> <li style='background-color: #000'><a href='https://github.com/shsgames/shsgames' target='_blank'>Github <i class='fa-brands fa-github'></i></a></li> <li style='background-color: #0675cf;'><a href='https://shsgames.github.io/' target='_blank'>Website <i class='fa-solid fa-gamepad'></i></a></li> <li style='background-color: #5865f2;'><a href='https://discord.gg/4Yb4yHeuxQ' target='_blank'>Discord <i style='color:#fff;' class='fa-brands fa-discord'></i></a></li> </ul> </div> </div> </div></div><hr>";
    }
            ...
            lines.push([
                {
                    ...
                    color: settings.darkTheme ? "#FFF" : "#00151f"
                }
            ]);
        var width = 0;
        var height = 20 * len + 2;
    ...
    function drawStats() {
        ...
        var rows = [
            ...
            stats.info.playersSpect + " watching",
    ...
    function drawGame() {
        ...
        if (!isNaN(stats.score)) {
            mainCtx.font = "30px Minecraftia";
            mainCtx.fillText("Score: " + stats.score, 2, height);
            height += 30;
        }
        mainCtx.font = "20px Minecraftia";
    ...
    window.openUpdates = function () {
        if (byId("update-body").innerHTML == "") buildUpdates();
        byId("update").show(0.5);
    };
    window.openCredits = function () {
        if (byId("credit-body").innerHTML == "") buildCredits();
        byId("credits").show(0.5);
    };
    ...
    window.MC = function () {
        var funny = ["You should join the discord :>",
            "if you see [OWNER] prkr...run",
            "LLJW 999",
            "LLJ 17",
            "I <3 Agario",
            "Yes, this is technically stealing from Minecraft",
            "you goofy asf if you still have a android",
            "guess who's in paris?",
            "school am I right?",
            "yall better have good grades",
            "Déjà vu",
            "please share I beg of you",
            "My name is splash, I'm as desprite as they come",
            "THATS WHAT SHE SAID",
            "Run, coward! I hunger!",
            "AAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
            "This really is my homework",
            "check out @marcopetrildesigns on ig <3",
            "MESSI!",
            "fun fact: Jupiter has 80 moons",
            "frank sinatra was ahead of his time",
            "F*CK ARSENAL FC!",
            "#DOOP",
            "this is so swag #kms",
            "fun fact: the philadelphia eagles are better than the cowboys",
            "why do people hate MEE6?!?",
            "Shoutout to the sons of ben",
            "SHSGames",
            "what the hell is iogames?!",
            "agario is king 👑😂",
            "K.I.D.S. is the best mixtape PERIOD",
            "can not say pop and forget the smoke",
            "shoot for the stars, aim for the moon",
            "everything will be okay.",
            "life is full of guarantees, some good some bad",
            "🧙‍♂️🎶🏟👨‍🎤🦸‍♀️",
            "FORTNITE!",
            "You know who else has dementia?",
            "i love bob 🐈‍⬛ and cooper 🐈 <3 ",
            "jake from state farm can go f*ck off",
            "i hate politics",
            "whats with everyone hating ye?",
            "WHAT THE HELL IS A KILOMETER?!!??",
            "(☞ ͡° ͜ʖ ͡°)☞",
            "¯\_(ツ)_/¯",
            "dream rotation: snoop dog, rodney dangerfield, mac miller",
            "tonight.",
            "the metaverse is such a sh*t concept",
            "j cole is FIRE!!",
            "DJ Khaled is not a good artist, but a great dancer :>",
            "i love you guys <3",
            "have a great day today",
            "you know what, f*ck you >:(",
            "british people with there wooden teeth",
            "who made jptr?!",
            "tip: don't be stupid",
            "shoutout to the bathroom for the free hand sanitizer",
            "serious question, the f*ck happened to dababy?",
            "listening to a young thug album is TOURTURE",
            "LOOK AT ME",
            "?",
            "!!!",
            "what you expect something crazy?",
            "this took way too long",
            "its 12:04 on christmas eve, and I wanna sleep so badly but I have to finish this or I WONT SLEEP",
            "shoutout to Norway, France and Latvia <3",
            "bro? you good?",
            "carry on",
            "Legends Never Die and Circles are hands down the best posthumous albums ever, change my mind",
            "go outside",
            "get off this game before its too late",
            "what clans exists in Agario?",
            "BOUND 2",
            "Im smart I swear.",
            "monkeys are awesome, s-tier animal",
            "would you eat yoshi's cookies?",
            "curious, how many of yall are failing high school?",
            "don't be afraid to speak in chat",
            "BATMAN!",
            "1 good girl = 1000 b*tches",
            "I don't support kanye, i jus like his music",
            "the party never ends",
            "i forgot to pay my taxes",
            "roblox is a pool of pedos",
            "who remembers club penguin?",
            "How much stuff can you stuff in a stuffie till your stuffies stuffed enough stuff?",
            "who even plays ea games for gameplay anymore",
            "fan duel and liberty mutual ads can go to hell",
            "to think the logo was saturn 🤦",
            "spongebob is the goat",
            "Hello World!",
            "Juice WRLD Remixes > Originals",
            "bmljZSBqb2IhIHlvdSB3YXN0ZWQgeW91ciB0aW1l",
            "who remembers Wizard101?",
            "thats enough for today",
            "you guys better behave >:(",
            "post malone = heaven",
            "🍎",
            "Shoutout to the FR Clan",
            "i m a d e j p t r",
            ...
            "♕𝕸𝖗♆𝕯𝖎𝖓𝖔☭",
            "https://discord.gg/UQ35z2ACNw",
            "Shout out to THE PIZZA EDITION"
        ];
        var sub = funny[Math.floor(Math.random() * funny.length)];
