...
public class GuiScreenKeystrokesOptions extends GuiScreen {
    /**
     * An array of options that can be changed directly from the options GUI.
     */
    private static final EnumOptions[] Options = new EnumOptions[]{EnumOptions.KEYSTROKES};
     ...
     */
    protected String screenTitle = "Keystrokes Options";

    public GuiScreenKeystrokesOptions(GuiScreen par1GuiScreen, GameSettings par2GameSettings) {
    ...
    public void initGui() {
        ...
        int var2 = 0;
        screenTitle = var1.translateKey("prcmenu.mods.keyStrokesOptions.title");
