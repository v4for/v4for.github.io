...
public class GuiScreenOptions extends GuiScreen {
     ...
     */
    private static final EnumOptions[] Options = new EnumOptions[]{EnumOptions.DYNAMIC_FOV, EnumOptions.VIGNETTE, EnumOptions.RAIN, EnumOptions.ADVANCED_ITEM_TOOLTIPS};
    ...
    public GuiScreenOptions(GuiScreen par1GuiScreen, GameSettings par2GameSettings) {
    ...
    public void initGui() {
        ...
        int var2 = 0;
        screenTitle = var1.translateKey("prcmenu.options.title");
