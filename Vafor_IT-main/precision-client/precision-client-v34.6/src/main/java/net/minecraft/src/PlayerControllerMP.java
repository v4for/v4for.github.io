...
public class PlayerControllerMP {
    ...
    /**
     * If modified to return true, the player spins around slowly around (0, 68.5,
     * 0). The GUI is disabled, the view is set to first person, and both chat and
     * menu are disabled. Unless the server is modified to ignore illegal stances,
     * attempting to enter a world at all will result in an immediate kick due to an
     * illegal stance. Appears to be left-over debug, or demo code.
     */
