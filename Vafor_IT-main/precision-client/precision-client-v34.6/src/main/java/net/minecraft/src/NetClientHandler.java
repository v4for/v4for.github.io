...
public class NetClientHandler extends NetHandler {
     ...
     * receipt of a player position packet, reset upon respawning.
     */
    private boolean doneLoadingTerrain = false;
    public MapStorage mapStorage = new MapStorage();
    ...
    private final GuiScreen field_98183_l = null;
    ...
    public void handleVehicleSpawn(Packet23VehicleSpawn par1Packet23VehicleSpawn) {
        ...
        if (var8 != null) {
            if (((Entity) var8).worldObj == null) ((Entity) var8).setWorld(worldClient);
    ...
    public void handleEntityExpOrb(Packet26EntityExpOrb par1Packet26EntityExpOrb) {
        EntityXPOrb var2 = new EntityXPOrb(this.worldClient, par1Packet26EntityExpOrb.posX, par1Packet26EntityExpOrb.posY, par1Packet26EntityExpOrb.posZ, par1Packet26EntityExpOrb.xpValue);
    ...
    public void handleEntityPainting(Packet25EntityPainting par1Packet25EntityPainting) {
        EntityPainting var2 = new EntityPainting(this.worldClient, par1Packet25EntityPainting.xPosition, par1Packet25EntityPainting.yPosition, par1Packet25EntityPainting.zPosition, par1Packet25EntityPainting.direction,
                par1Packet25EntityPainting.title);
    ...
    public void handleKickDisconnect(Packet255KickDisconnect par1Packet255KickDisconnect) {
        ...
        if (par1Packet255KickDisconnect.reason.equalsIgnoreCase("BLOCKED")) {
            ...
            this.mc.stopServerAndDisplayGuiScreen(new GuiDisconnected(backToMenu(), "disconnect.disconnected", "disconnect.genericReason", par1Packet255KickDisconnect.reason));
        }
    }
    ...
    public void handleMobSpawn(Packet24MobSpawn par1Packet24MobSpawn) {
        ...
        var10.setPositionAndRotation(var2, var4, var6, var8, var9);
        var10.motionX = (float) par1Packet24MobSpawn.velocityX / 8000.0F;
        var10.motionY = (float) par1Packet24MobSpawn.velocityY / 8000.0F;
        var10.motionZ = (float) par1Packet24MobSpawn.velocityZ / 8000.0F;
    ...
    private Entity getEntityByID(int par1) {
        return par1 == this.mc.thePlayer.entityId ? this.mc.thePlayer : this.worldClient.getEntityByID(par1);
    }
    ...
    public void handleExplosion(Packet60Explosion par1Packet60Explosion) {
        Explosion var2 = new Explosion(this.mc.theWorld, null, par1Packet60Explosion.explosionX, par1Packet60Explosion.explosionY, par1Packet60Explosion.explosionZ, par1Packet60Explosion.explosionSize);
        var2.affectedBlockPositions = par1Packet60Explosion.chunkPositionRecords;
        var2.doExplosionB(true);
        this.mc.thePlayer.motionX += par1Packet60Explosion.getPlayerVelocityX();
        this.mc.thePlayer.motionY += par1Packet60Explosion.getPlayerVelocityY();
        this.mc.thePlayer.motionZ += par1Packet60Explosion.getPlayerVelocityZ();
    }
    ...
    public void handleUpdateSign(Packet130UpdateSign par1Packet130UpdateSign) {
        ...
        if (this.mc.theWorld.blockExists(par1Packet130UpdateSign.xPosition, par1Packet130UpdateSign.yPosition, par1Packet130UpdateSign.zPosition)) {
            ...
            if (var3 instanceof TileEntitySign) {
                ...
                if (var4.isEditable()) {
                    System.arraycopy(par1Packet130UpdateSign.signLines, 0, var4.signText, 0, 4);
    ...
    public void handleBlockEvent(Packet54PlayNoteBlock par1Packet54PlayNoteBlock) {
        this.mc.theWorld.addBlockEvent(par1Packet54PlayNoteBlock.xLocation, par1Packet54PlayNoteBlock.yLocation, par1Packet54PlayNoteBlock.zLocation, par1Packet54PlayNoteBlock.blockId, par1Packet54PlayNoteBlock.instrumentType,
                par1Packet54PlayNoteBlock.pitch);
    }

    public void handleBlockDestroy(Packet55BlockDestroy par1Packet55BlockDestroy) {
        this.mc.theWorld.destroyBlockInWorldPartially(par1Packet55BlockDestroy.getEntityId(), par1Packet55BlockDestroy.getPosX(), par1Packet55BlockDestroy.getPosY(), par1Packet55BlockDestroy.getPosZ(),
                par1Packet55BlockDestroy.getDestroyedStage());
    }
        ...
        if (var3 == 1) {
            ...
            if (var4 == 0) {
                ...
                this.mc.ingameGUI.getChatGUI().addTranslatedMessage("demo.help.movement",
                        EaglerAdapter.getKeyName(var5.keyBindForward.keyCode), EaglerAdapter.getKeyName(var5.keyBindLeft.keyCode), EaglerAdapter.getKeyName(var5.keyBindBack.keyCode), EaglerAdapter.getKeyName(var5.keyBindRight.keyCode));
            } else if (var4 == 102) {
                this.mc.ingameGUI.getChatGUI().addTranslatedMessage("demo.help.jump", EaglerAdapter.getKeyName(var5.keyBindJump.keyCode));
            } else if (var4 == 103) {
                this.mc.ingameGUI.getChatGUI().addTranslatedMessage("demo.help.inventory", EaglerAdapter.getKeyName(var5.keyBindInventory.keyCode));
            }
        } else if (var3 == 6) {
    ...
    public void handleStatistic(Packet200Statistic par1Packet200Statistic) {
        if (par1Packet200Statistic.statisticId >= 5242880) {
            for (Achievement m : AchievementList.achievementList) {
                if (m.statId == par1Packet200Statistic.statisticId) {
                    this.mc.thePlayer.incrementStat(m, 1);
                    break;
                }
            }
        }
    ...
    public void handleWorldParticles(Packet63WorldParticles par1Packet63WorldParticles) {
        for (int var2 = 0; var2 < par1Packet63WorldParticles.getQuantity(); ++var2) {
            ...
            this.worldClient.spawnParticle(par1Packet63WorldParticles.getParticleName(), par1Packet63WorldParticles.getPositionX() + var3, par1Packet63WorldParticles.getPositionY() + var5, par1Packet63WorldParticles.getPositionZ() + var7,
                    var9, var11, var13);
        }
    }
