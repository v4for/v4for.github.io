...
public class BlockEnderChest extends BlockContainer {
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, EaglercraftRandom par5Random) {
        for (int var6 = 0; var6 < 3; ++var6) {
            double var10000 = (float) par2 + par5Random.nextFloat();
            double var9 = (float) par3 + par5Random.nextFloat();
            var10000 = (float) par4 + par5Random.nextFloat();
            double var13 = 0.0D;
            double var15 = 0.0D;
            double var17 = 0.0D;
            ...
            var17 = par5Random.nextFloat() * 1.0F * (float) var20;
            double var7 = (double) par2 + 0.5D + 0.25D * (double) var19;
            var13 = par5Random.nextFloat() * 1.0F * (float) var19;
