...
public final class ItemStack {
     ...
     * has the Unbreaking enchantment there is a chance for each point of damage to
     * be negated. Returns true if it takes more damage than getMaxDamage(). Returns
    ...
    public List getTooltip(EntityPlayer par1EntityPlayer, boolean par2) {
        ...
        if (par2) {
            ...
            if (this.getHasSubtypes()) {
                var5 = var5 + String.format("#%04d/%d%s", Integer.valueOf(this.itemID), Integer.valueOf(this.itemDamage), var6);
            } else {
