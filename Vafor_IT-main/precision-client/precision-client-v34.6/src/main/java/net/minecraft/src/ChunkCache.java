...
public class ChunkCache implements IBlockAccess {
    ...
    /**
     * Brightness for SkyBlock.Sky is clear white and (through color computing it is
     * assumed) DEPENDENT ON DAYTIME. Brightness for SkyBlock.Block is yellowish and
     * independent.
     */
