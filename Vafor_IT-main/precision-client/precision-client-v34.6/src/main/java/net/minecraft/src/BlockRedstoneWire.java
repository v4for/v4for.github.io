...
public class BlockRedstoneWire extends Block {
        ...
        if (!this.wiresProvidePower) {
            ...
            if (var6 == 0) {
                ...
                return !var9 && !var8 && !var7 && !var10 && par5 >= 2 && par5 <= 5 ? var6
                        : (par5 == 2 && var9 && !var7 && !var8 ? var6 : (par5 == 3 && var10 && !var7 && !var8 ? var6 : (par5 == 4 && var7 && !var9 && !var10 ? var6 : (par5 == 5 && var8 && !var9 && !var10 ? var6 : 0))));
            }
        }
    }
    ...
    public static Icon func_94409_b(String par0Str) {
        return par0Str == "redstoneDust_cross" ? Block.redstoneWire.field_94413_c
                ...
                : (par0Str == "redstoneDust_cross_overlay" ? Block.redstoneWire.field_94411_cP : (par0Str == "redstoneDust_line_overlay" ? Block.redstoneWire.field_94412_cQ : null)));
    }
}
