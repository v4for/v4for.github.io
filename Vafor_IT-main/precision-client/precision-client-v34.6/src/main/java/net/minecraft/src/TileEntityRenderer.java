...
public class TileEntityRenderer {
    ...
    /**
     * Returns the TileEntitySpecialRenderer used to render this TileEntity class,
     * or null if it has no special renderer
     */
     ...
     * RenderEngine, FontRenderer, and the camera- bound EntityLiving's interpolated
     * pitch, yaw and position. Args: world, renderengine, fontrenderer,
