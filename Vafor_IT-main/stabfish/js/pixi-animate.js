 ...
 */
(function (f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } g.pixiAnimate = f() } })(function () {
        ...
        1: [function (require, module, exports) {
            ...
            var MovieClip = function (_Container) {
                ...
                MovieClip.prototype._tickListener = function _tickListener(tickerDeltaTime) {
                    ...
                    var seconds = tickerDeltaTime / PIXI.settings.TARGET_FPMS / 1000;
                ...
                MovieClip.prototype._setTimelinePosition = function _setTimelinePosition(startFrame, currentFrame, doActions) {
                    if (startFrame !== currentFrame && doActions) {
                        var startPos = isNaN(startFrame) ? currentFrame : startFrame >= this._totalFrames - 1 ? 0 : startFrame + 1;
                        // generate actionFrames on the way
                        var actionFrames = []; // number[]
                        // loop
                        if (currentFrame < startPos) {
                            for (var _i2 = startPos; _i2 < this._actions.length; ++_i2) {
                                this._actions[_i2] && actionFrames.push(_i2);
                            }
                            for (var _i3 = 0; _i3 <= currentFrame; ++_i3) {
                                this._actions[_i3] && actionFrames.push(_i3);
                            }
                        }
                        // no loop
                        else {
                            for (var _i4 = startPos; _i4 <= currentFrame; ++_i4) {
                                this._actions[_i4] && actionFrames.push(_i4);
                            }
                        }

                        if (actionFrames.length) {
                            var oldCurrentFrame = this.currentFrame;
                            for (var _i5 = 0; _i5 < actionFrames.length; ++_i5) {
                                var frame = actionFrames[_i5];
                    ...
                    if (doActions && this._actions && this._actions[currentFrame]) {
                        ...
                        for (var _j = 0; _j < frameActions.length; ++_j) {
                            frameActions[_j].call(this);
                        }
                    }
                };
                ...
                MovieClip.prototype.destroy = function destroy(destroyChildren) {
                    ...
                    if (timelines) {
                        for (var _i6 = 0; _i6 < timelines.length; _i6++) {
                            var _timeline = timelines[_i6];
                    ...
                    for (var _i7 = 0; _i7 < hiddenChildren.length; _i7++) {
                        // Don't destroy children in the display list
                        if (this.children.indexOf(hiddenChildren[_i7]) < 0) {
                            hiddenChildren[_i7].destroy(destroyChildren);
                        }
                    }
            ...
            var Scene = function (_PIXI$Application) {
                ...
                function Scene(width, height, renderOptions, noWebGL) {
                    ...
                    renderOptions.forceCanvas = noWebGL;
                    /**
               ...
               * @readOnly
               */
                    var _this = _possibleConstructorReturn(this, _PIXI$Application.call(this, renderOptions));
              ...
              * @return {PIXI.Loader} instance of PIXI resource loader
              */
            ...
            // PIXI.Loader.addPixiMiddleware(SymbolLoader);
             ...
             * @param {Function} [complete] The callback function when complete.
             * @param {String} [basePath] Base root directory
             * @param {PIXI.Loader} [loader] A Pixi loader object
